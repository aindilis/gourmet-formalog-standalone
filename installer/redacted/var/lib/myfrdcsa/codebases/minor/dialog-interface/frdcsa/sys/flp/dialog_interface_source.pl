...
%% :- prolog_consult('/var/lib/myfrdcsa/codebases/minor/dialog-interface/frdcsa/sys/flp/dialog_interface_regex.pl').
:- prolog_consult('/var/lib/myfrdcsa/codebases/minor/free-life-planner/profile.pl').

:- prolog_consult('/var/lib/myfrdcsa/codebases/minor/dialog-interface/frdcsa/sys/flp/dialog_interface_dcg.pl').
:- prolog_consult('/var/lib/myfrdcsa/codebases/minor/dialog-interface/frdcsa/sys/flp/generate_response.pl').

:- prolog_consult('/var/lib/myfrdcsa/codebases/minor/dialog-interface/frdcsa/sys/flp/world_knowledge.pl').

%% QUERY/RESPONSE
:- prolog_consult('/var/lib/myfrdcsa/codebases/minor/dialog-interface/frdcsa/sys/flp/dialog/query.pl').
:- prolog_consult('/var/lib/myfrdcsa/codebases/minor/dialog-interface/frdcsa/sys/flp/dialog/response.pl').

:- prolog_consult('/var/lib/myfrdcsa/codebases/minor/dialog-interface/frdcsa/sys/flp/dialog/triggers.pl').

%% FIXME: merge mapNLToTerm and hasEnglishGloss(es)
